...
import { getMyLibrary, getProfile as fetchProfile, toConditionLabel, type BookListItem, type UserProfile } from '@/lib/books';
...
const styles = StyleSheet.create({
  ...
  successBanner: { marginHorizontal: 20, marginTop: 14, borderRadius: 12, borderWidth: 1, borderColor: '#9be4b9', backgroundColor: '#dbf7e5', paddingHorizontal: 14, paddingVertical: 12, flexDirection: 'row', alignItems: 'center', gap: 8 },
  successText: { color: '#0b7f3f', fontFamily: 'Outfit_700Bold', fontSize: 15 },
  profileTop: { paddingHorizontal: 20, paddingTop: 20, alignItems: 'center' },
  ...
  statsRow: { marginTop: 18, paddingHorizontal: 20, flexDirection: 'row', gap: 12 },
  ...
  sectionButton: { marginTop: 14, marginHorizontal: 20, borderRadius: 999, borderWidth: 2, borderColor: '#e07a5f', backgroundColor: '#f5f3f0', paddingVertical: 12, alignItems: 'center' },
